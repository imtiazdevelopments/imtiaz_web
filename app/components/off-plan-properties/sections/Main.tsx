    ...
    <section className="w-full bg-white pt-70" data-header="dark">
      <div className="w-full container">
        ...
        <div className="lg:hidden mb-70">
          ...
          >
            ...
            >
              ...
              <span
                className="transition-transform duration-300 ease-in-out"
                style={{ transform: filtersOpen ? "rotate(45deg)" : "rotate(0deg)" }}
              >
                <Plus size={20} />
              </span>
            </button>
        ...
        <div className="hidden lg:block mb-70">
          ...
          >
            {/* Left: filter dropdowns */}
            <motion.div variants={containerStagger} className="flex items-center gap-20 3xl:gap-40">
              <motion.div variants={moveUp(0)} className="w-full">
                <FilterDropdown
                  placeholder="All Bedrooms"
                  options={bedrooms}
            ...
            {/* Right: Clear Filter + inline toggle */}
            <div className="flex items-center justify-end xl:justify-between gap-20 3xl:gap-50">
              {hasFilter && (
                <motion.div
                  className="w-full md:w-auto"
      ...
      <div className="container mb-50 text-center" id="properties-list">
        ...
        <SectionDescription
          ...
          text={
            filtered.length !== 0
              ? `Showing ${(currentPage - 1) * ITEMS_PER_PAGE + 1}–${Math.min(currentPage * ITEMS_PER_PAGE, filtered.length)} of ${filtered.length} premium developments`
              : ""
          }
        />
      </div>
