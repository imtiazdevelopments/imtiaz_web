    ...
    >
      <div ref={rootRef}>
                    ...
                    >
                      ...
                      <div className="overflow-hidden">
                        ...
                        >
                          ...
                          <p className="text-primary font-[avenirBook] text-17">
                            Read More...
                          </p>
                          {/* </Link> */}
                        </motion.div>
        ...
        <div className="overflow-hidden">
          ...
          >
            <button className="border cursor-pointer border-primary text-primary px-[36px] py-[19.5px] max-h-[62px] rounded-full font-[avenirRoman] text-[17px] hover:bg-primary hover:text-white transition-colors duration-300">
              View All
            </button>
