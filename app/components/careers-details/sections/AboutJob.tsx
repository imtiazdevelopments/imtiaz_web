...
const AboutJob = ({ data }: Props) => {
  return (
    <section className="w-full bg-white py-120 3xl:py-[160px]" data-header="dark">
      <div className="container  ">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }} 
          className="mt-50 pb-50 border-t border-black/10"
        ></motion.div>
        <motion.div
          variants={moveUp(0.1)}
          initial="hidden"
        ...
        <div key={index}>
          <h3 className="mb-20 uppercase text-25 font-[optima] leading-[1.4]">{index + 1}. {section.title}</h3>
          <ul className="mb-30 list-disc pl-5">
