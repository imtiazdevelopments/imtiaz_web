        ...
        {open && (
          <motion.div
            ...
            className={`absolute top-[calc(100%+8px)] h-[250px] left-0 min-w-[250px] w-full backdrop-blur-md border rounded-2xl shadow-lg overflow-hidden z-50 ${
              isLight
                ? "bg-white border-foreground-light/50"
                : "bg-foreground-light border-black/10"
            }`}
              ...
              <input
                ...
                className={`w-full text-description bg-transparent outline-none p-0 ${
                  isLight
                    ...
                    : "text-foreground-light placeholder:text-white"
                }`}
              />
            </div>
            {/* List */}
              ...
              {filtered.map((c, i) => (
                <div key={`${c.name}-${i}`}>
                  ...
                  >
                    ...
                    <span
                      className={`truncate text-[13px] ${isLight ? "text-foreground" : "text-white"}`}
                    >
                      {c.name}
                    </span>
                  </button>
