        ...
        >
            <div className="relative w-full h-full overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        background: "linear-gradient(180deg, rgba(0, 0, 0, 0) 44.3%, #000000 100%), linear-gradient(0deg, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4))",
                    }}
                />
                ...
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-between py-7 lg:py-10 px-8 lg:px-5 opacity-0 group-hover:opacity-100 group-[.is-active]:opacity-100 transition-opacity duration-500">
                    ...
                    <div className="flex flex-col items-center gap-1 mt-3 xl:mt-[48px] -translate-y-2 group-hover:translate-y-0 group-[.is-active]:translate-y-0 transition-transform duration-300 delay-100">
                        <Image src={hoverImage} alt="Hover Image" width={160} height={70} className="h-[50px]  lg:h-[70px]  w-auto" />
                    </div>

                    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 2xl:gap-[20px] w-full 2xl:px-[117px] py-1 translate-y-2 group-hover:translate-y-0 group-[.is-active]:translate-y-0 transition-transform duration-500 delay-100">
                        ...
                        <div className="flex items-center gap-[10px]">
                            ...
                            <div className="flex flex-col items-baseline">
                                <span className="text-white text-description uppercase text-left">Starting From</span>
                        ...
                        <div className="flex items-center gap-[10px]">
                            ...
                            <div className="flex flex-col items-baseline">
                                <span className="text-white text-description uppercase text-left">Units</span>
