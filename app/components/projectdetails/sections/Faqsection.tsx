...
function AccordionItem({
  ...
  return (
    <div>
      ...
      <button
        onClick={onToggle}
        className={`${isOpen ? "2xl:pb-20" : ""} w-full flex items-start sm:items-center justify-between cursor-pointer gap-20 ${isLast ? `pt-40 ${!isOpen ? "pb-0" : ""}` : "py-40"} text-left group focus:outline-none`}  
...
export default function Faq() {
  ...
  return (
    <section
      className="w-full  py-120 3xl:pt-160 3xl:pb-[100px] "
      data-header="dark"
    >
