...
const MeydanHorizon = () => {
    ...
    <section className="w-full py-120 3xl:py-160"  >
      <div className="container flex flex-col justify-center">
        ...
        <div className="text-center ">
          <SectionHeading title={title} className="text-heading  text-foreground mb-20 max-w-[666px] mx-auto" />
        
           <SectionDescription text={subtitle} className="text-25 uppercase font-[optima] mb-40 text-foreground-light leading-[1.5] md:leading-[1.4] font-normal" />
  ...
  <div ref={desktopBtnRef}  style={{ opacity: 0 }}>
          ...
          <CustomOutlineButton text="View Community"
           px="px-[12px] lg:px-[20px] 3xl:px-[39.44px] 3xl:py-[23px] mx-auto mt-50"
