...
const ErrorSlot = ({ msg }: { msg?: string }) => (
  <p className="text-[14px] text-[#c0392b] md:pt-2 h-media md:h-20">
    {msg ?? "\u00A0"}
  </p>
);
...
const TabButton = ({ label, isActive, onClick }: TabButtonProps) => {
  return (
    <button
      onClick={onClick}
      className={`relative min-h-[55px] cursor-pointer lg:min-h-[70px] z-10 w-1/2 px-2 py-3 lg:py-[17.5px] uppercase text-25 font-[optima] leading-[1.5] md:leading-[1.4] transition-colors duration-300 ${
