        ...
        <div className="w-full lg:w-[48.5%] flex-shrink-0 flex flex-col">
          ...
          <div className="flex items-center gap-4">
            <div className="w-[70px] h-[48px] bg-white rounded-[6px] flex items-center justify-center border border-[#EBEBEC]">
              <Image src="/images/pay-now/cards/mastercard.svg" alt="Mastercard" width={45} height={30} className="w-[45px] h-[27.61px] object-contain pointer-events-none" />
            </div>
            <div className="w-[70px] h-[48px] bg-white rounded-[6px] flex items-center justify-center border border-[#EBEBEC]">
              <Image src="/images/pay-now/cards/maestro.svg" alt="Maestro" width={50} height={20} className="w-[45px] h-[27.61px] object-contain pointer-events-none" />
            </div>
            <div className="w-[70px] h-[48px] bg-white rounded-[6px] flex items-center justify-center border border-[#EBEBEC]">
              <Image src="/images/pay-now/cards/visa.svg" alt="Visa" width={32} height={20} className="w-[49px] h-[15.64px] object-contain pointer-events-none" />
            </div>
            <div className="w-[70px] h-[48px] relative bg-white rounded-[6px] flex items-center justify-center border border-[#EBEBEC]">
              <div className="absolute bottom-0 right-0 flex items-center justify-center">
                <Image src="/images/pay-now/cards/discover.svg" alt="Discover" width={70} height={30} className="w-[62.37px] h-[28px] object-contain pointer-events-none" />
              </div>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className="grid grid-cols-2 gap-70 3xl:gap-90">
              <div className="group">
                ...
                <input id="firstName" type="text" className={inputClass} {...register("firstName", { required: "Required" })} />
                <FieldLine hasError={!!errors.firstName} />
                <ErrorSlot msg={errors.firstName?.message} />
              </div>
              <div className="group">
                <label htmlFor="lastName" className="block text-description text-foreground-light/50 transition-colors group-focus-within:text-foreground-light">
                  Enter Your Last Name
                </label>
                <input id="lastName" type="text" className={inputClass} {...register("lastName", { required: "Required" })} />
                ...
                <div className="flex items-end mt-20 gap-2">
                  ...
                  <input
                    ...
                    {...register("phone", {
                      ...
                      pattern: { value: /^[0-9]{7,15}$/, message: "Invalid number" },
                    })}
                  />
                </div>
            ...
            <div className="group">
              ...
              <input
                ...
                {...register("amount", {
                  ...
                  max: { value: 100000, message: "Please Enter Amount less than or equal to 100,000 (AED)" },
                })}
              />
              <FieldLine hasError={!!errors.amount} />
              <ErrorSlot msg={errors.amount?.message} hint="Please Enter Amount less than or equal to 100,000 (AED)" />
            </div>
