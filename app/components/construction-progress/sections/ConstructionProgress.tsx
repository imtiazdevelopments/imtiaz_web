    ...
    months: [
      {
        ...
        images: [
          { src: "/images/construction-progress/slide01.jpg", alt: "March 2025 - 1" },
          { src: "/images/construction-progress/slide02.jpg", alt: "March 2025 - 2" },
        ],
      },
      {
        month: "February",
        ...
        location: "Sunset Bay 5 by Imtiaz",
        images: [
          { src: "/images/construction-progress/slide02.jpg", alt: "February 2025 - 1" },
          { src: "/images/construction-progress/slide01.jpg", alt: "February 2025 - 2" },
        ],
      },
      {
        month: "January",
        ...
        location: "Sunset Bay 5 by Imtiaz",
        images: [
          { src: "/images/construction-progress/slide03.jpg", alt: "January 2025 - 1" },
          { src: "/images/construction-progress/slide02.jpg", alt: "January 2025 - 2" },
        ],
      },
    ],
  },
    ...
    months: [
      {
        ...
        location: "Sunset Bay 5 by Imtiaz",
        images: [
          { src: "/images/construction-progress/slide01.jpg", alt: "March 2026 - 1" },
          { src: "/images/construction-progress/slide03.jpg", alt: "March 2026 - 2" },
        ],
      },
      {
        month: "February",
        ...
        location: "Sunset Bay 5 by Imtiaz",
        images: [
          { src: "/images/construction-progress/slide02.jpg", alt: "February 2026 - 1" },
          { src: "/images/construction-progress/slide01.jpg", alt: "February 2026 - 2" },
        ],
      },
    ],
  },
...
const TabButton = ({ year, isActive, onClick }: TabButtonProps) => {
  return (
    // <motion.button
    //   onClick={onClick}
    //   className={`px-[50px] py-[16px] rounded-full text-description transition-all duration-300 ${
    //     isActive
    //       ? "bg-[#611215] text-white"
    //       : "bg-transparent border-2 border-gray-300 text-gray-700 hover:border-gray-400"
    //   }`}
   ...
   onClick={onClick} className={`min-w-[96px] md:min-w-[136px] min-h-[50px] md:min-h-[58px] cursor-pointer flex items-center justify-center group relative transition-all duration-300 undefined overflow-hidden px-[12px] sm:px-[26px]
    xl:px-[37px] py-[14px] lg:py-4 2xl:py-[19px] 3xl:py-[20.62px] rounded-full border  text-foreground-light font-[avenirBook] text-[16px] md:text-[19px] leading-[100%]  ${
      ...
      <div className="flex items-center gap-[10px] 2xl:gap-[10px]">
        <span className={`absolute inset-y-0 left-0 w-[50%] bg-primary-2 transform scale-x-0 origin-left transition-transform duration-300 ease-out group-hover:scale-x-100  
          ${
        isActive
           ? "scale-x-100"
           : ""
     }`}></span>
        <span className={`absolute inset-y-0 right-0 w-[50%] bg-primary-2 transform scale-x-0 origin-right transition-transform duration-300 ease-out group-hover:scale-x-100  ${
        isActive
           ? "scale-x-100"
           : ""
     }` }></span>
        <span className={`relative z-10 transition-colors duration-300 md:min-w-[98px] inline-block text-center group-hover:text-white ${isActive ? "text-white" : ""}`}>  {year}</span>
      </div>
    </button>
  );
};
...
const MonthCard = ({ monthData, index }: MonthCardProps) => {
 ...
 <motion.div
        ...
        >
          ...
          {/* Pagination */}
          <div className={`swiper-pagination-${index} absolute bottom-4 left-1/2 -translate-x-1/2 z-10`} />
        </div>
