      ...
      >
        ...
        >
          <button
            ...
            className="lg:w-[50px] lg:h-[50px] 3xl:w-[62px] 3xl:h-[62px] w-[45px] h-[45px] border border-white rounded-[50px] flex items-center justify-center overflow-hidden relative"
          >
        ...
        <div className="absolute bottom-130 left-1/2 -translate-x-1/2 z-30 flex items-center justify-center gap-3">
          {images.map((_, i) => (
            <button
              ...
              className={`rounded-full transition-all duration-300 cursor-pointer border border-white w-[10px] h-[10px] ${i === 0 ? "bg-white" : ""}`}
            />
          ))}
        </div>
      </div>
