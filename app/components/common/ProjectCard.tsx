      ...
      <div className="relative w-full aspect-[8.2/10] md:aspect-[9/13] xl:aspect-[8.5/13] 3xl:aspect-[8.48/13] overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col justify-center gap-7 w-full">
            <div
              className={`flex sm:flex-col md:flex-row items-center sm:items-start md:items-center justify-between gap-30 lg:gap-40 w-full sm:w-fit md:w-full py-1 transition-transform duration-500 delay-100 ${show ? "translate-y-0" : "translate-y-2"}`}
            >
              <div className="flex items-center gap-[10px]">
                ...
                <div className="flex flex-col items-baseline gap-1">
                  <span className="text-white text-description projectCardFontSize text-left">
                    Starting From
                  </span>
                  <span className="text-white text-description projectCardFontSize text-left">
                    {startingFrom}
