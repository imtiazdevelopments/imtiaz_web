...
export default function ProjectCard({
  ...
  return ( 
      ...
      onTouchCancel={() => setIsActive(false)}
       ref={ref}
    >
      <div className="relative w-full aspect-[12/13] lg:aspect-[11/13] xl:aspect-[8.48/13] overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-between py-7 lg:py-10 px-8 lg:px-5 opacity-0 group-hover:opacity-100 group-[.is-active]:opacity-100 transition-opacity duration-500">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 2xl:gap-[20px] w-full 2xl:px-[17px] py-1 translate-y-2 group-hover:translate-y-0 group-[.is-active]:translate-y-0 transition-transform duration-500 delay-100">
            ...
            <div className="flex items-center gap-[10px]">
              <div className="w-[49px] h-[49px] rounded-full bg-white/20 backdrop-blur-sm will-change-transform transform-gpu flex items-center justify-center shrink-0">
          ...
          <CustomOutlineButton
            text="View Property"
            px="px-[12px] sm:px-[26px] 3xl:px-[40.4px] 3xl:!py-[23px]"
