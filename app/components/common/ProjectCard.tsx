...
//   return (
//     <div
//       className={`group block w-full ${isActive ? "is-active" : ""}`}
...
//           <button className="-translate-y-2 group-hover:translate-y-0 group-[.is-active]:translate-y-0 transition-transform duration-900 delay-140 cursor-pointer flex items-center justify-center   relative transition-all duration-300  translate-y-2 btncard  3xl:py-[21px] transition-transform duration-300 delay-100 overflow-hidden px-[20px] lg:px-[25px] 2xl:px-[30px] 3xl:px-[40px] py-[14px] lg:py-4 2xl:py-[19px] 3xl:py-[20.62px] rounded-full border border-white/90 text-white font-[avenirHeavy] text-19 leading-[100%]">
...
//             <span className="relative z-10 transition-colors duration-300 min-w-[98px] inline-block text-center ">
//               View Property
//             </span>
//           </button>
//         </div>
    ...
    >
      <div className="relative w-full aspect-[9.9/13] sm:aspect-[9.4/13] md:aspect-[9/13] xl:aspect-[8.8/13] 3xl:aspect-[8.48/13] overflow-hidden">
        ...
        >
          ...
          <div className={`absolute bottom-0 xl:bottom-[13px] left-0 right-0 px-5 transition-opacity duration-500 ${show ? "opacity-0" : "opacity-100"}`}>
            <h3
        ...
        {/* ── HOVER STATE ── */}
        <div
          className={`absolute inset-0 z-20 flex flex-col items-center justify-between py-80 3xl:py-[88px] px-20 transition-opacity delay-140 duration-500 ${show ? "opacity-100" : "opacity-0"}`}
        >
