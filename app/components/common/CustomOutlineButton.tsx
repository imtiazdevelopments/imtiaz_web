...
const CustomOutlineButton = ({
  ...
  return (
    <button
      ...
      className={`cursor-pointer group relative transition-all duration-300 ${className} overflow-hidden ${px} py-[14px] lg:py-5 rounded-full border ${borderColor} ${textColor} font-[avenirRoman] text-19 leading-[100%]`}
