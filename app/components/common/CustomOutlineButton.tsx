...
const CustomOutlineButton = ({
  ...
  return (
    <button
      ...
      className={`cursor-pointer flex items-center justify-center group relative transition-all duration-300 ${className} overflow-hidden ${px} py-[14px] lg:py-4 3xl:py-[20.62px] rounded-full border ${borderColor} ${textColor} font-[avenirHeavy] text-19 leading-[100%]`}
