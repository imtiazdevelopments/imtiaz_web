...
export default function SliderArrowButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`
        relative w-[62px] h-[62px] group rounded-[50px] flex items-center justify-center overflow-hidden
    ...
    >
      ...
      <Image
        ...
        height={28}
        className={`
          relative z-10 object-contain w-[28px] h-[28px] transition-all duration-300
          ${isNext ? "rotate-180" : ""}
          ${
            isDark
