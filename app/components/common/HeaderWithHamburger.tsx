...
//               <div
//                 className={clsx(
//                   "bckbg backdrop-blur-[30px] left-1/2 w-0 -translate-x-1/2 absolute h-[50px] md:h-[65px] lg:h-[75px] 3xl:h-[80px] rounded-[150px] z-[-1] transition-all duration-500",
...
//                     className="flex items-center justify-center w-[32px] h-[32px] sm:bg-white/25 sm:backdrop-blur-[30px] sm:rounded-full cursor-pointer opacity-0"
//                   >
//                     <Image
//                       src="/images/account.svg"
//                       alt="account"
...
//                   <button className="flex items-center justify-center gap-[8px] h-[32px] w-[32px] md:w-auto sm:px-[6px] sm:bg-white/25 sm:backdrop-blur-[30px] sm:rounded-full cursor-pointer opacity-0">
//                     <Image
//                       src="/images/map.svg"
//                       alt="map"
//                       width={24}
