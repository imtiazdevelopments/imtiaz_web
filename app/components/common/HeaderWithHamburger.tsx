...
const HeaderWithHamburger: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Responsive start → end heights matching Tailwind breakpoints
    let startH: string, endH: string, hdrcntsH: string;
